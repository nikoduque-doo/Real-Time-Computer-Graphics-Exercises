public class toMesh_3 {
    ...
    public static Mesh getMesh(double[][] arr, double scaleX, double scaleY, double scaleZ){
        ...
        return new Mesh(vertices, faces, normals, textureCoordinates);
    }
    ...
    public static double[][] getNormalMatrix(double[][] arr, double scaleX, double scaleY){
    ...
    public static double[][] getTextureCoordinates(double[][] arr, double scaleX, double scaleY){
